...
import avatarSrc from './avatar.svg'
...
export function Header() {
	return (
		<header className='flex items-center h-24 bg-white shadow-lg px-8'>
			...
			<button className="w-44 bg-teal-600 hover:bg-teal-500
			 transition-colors text-white rounded-lg px-5 py-2 text-2xl leading-tight">
				Play
			</button>
			<button className="ml-auto flex items-center gap-2 text-start
			text-teal-600 hover:text-teal-500 transition-colors">
				<Image src={avatarSrc} alt='avatar' width={48}
					height={48} unoptimized />
				<div>
